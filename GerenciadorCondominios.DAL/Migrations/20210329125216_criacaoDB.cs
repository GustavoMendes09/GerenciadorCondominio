        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartamento_Usuarios_MoradorId",
                        column: x => x.MoradorId,
                        principalTable: "Usuarios",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Apartamento_Usuarios_ProprietarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Pagamentos_Usuarios_UsuarioId1",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "439a7e51-3489-4855-a23d-a53c428f35a2", "f4ed6d8c-d4d2-456c-8d26-6e4cb009583c", "Morador do Prédio", "Morador", "MORADOR" },
                    { "75938b86-2ea7-4f4c-a543-e31b9330d8e8", "3aae98cd-4abb-4793-a5cb-9b46c8dcaf17", "Síndico do Prédio", "Sindico", "SINDICO" },
                    { "256ebcc6-a5a2-455c-90f9-027b1b7f112f", "505f516b-cbf2-4916-9676-bf3175a0c6c7", "Administrador do Prédio", "Administrador", "ADMINISTRADOR" }
                });
